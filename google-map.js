...
.directive('googleMap', function ($stateParams,maps, MapOptions) {
  return function(scope, element, attrs) {
    ...
    // Belgrade position
    var location = new google.maps.LatLng(47.48076238914876, -122.2793815);
    ...
    scope.$on('loc',function(event,data){
      ...
      if(data.succeed == 1){
        ...
        input.placeholder='Put in Fishing Spots';
        ...
        var input = document.getElementById('pac-input');
        input.placeholder='Geolocation failed, search new location eg. \'Put in Fishing Spots\'';
      }
    ...
    var SearchFunc = function(){
      ...
      var defaultBounds = new google.maps.LatLngBounds(
        new google.maps.LatLng(47.61498413271605, -122.33584224999998),
        new google.maps.LatLng(47.3856825825806, -122.20574905000001));
